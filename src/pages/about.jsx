...
const About = () => {
  return (
    ...
    justify-center w-[100%] "
      >
        <Layout className="pt-0 md:pt-16 sm:pt-20 z-0 ">
          <AnimatedText
          ...
          <div className="flex w-full flex-row lg:flex-col">
            <div className="basis-1/2 flex flex-col items-start justify-center lg:basis-full lg:order-2 pr-3 lg:pr-0">
          ...
          33vw"
            ...
            <div className="basis-1/6 flex relative flex-col items-end justify-between lg:basis-full lg:flex-row lg:items-baseline lg:place-content-evenly lg:order-3">
              {stat.map((data, index) => (
                <div
                  key={index}
                  className={`relative flex flex-col items-end lg:items-center justify-end ${
                    index === 0 ? "pl-0" : ""
